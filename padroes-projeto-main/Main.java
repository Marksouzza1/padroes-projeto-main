...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println(
                    "1 - Cadastrar Curso\n2 - Pesquisar Curso\n3 - Alterar Curso\n4 - Excluir Curso\n5 - Cadastrar Disciplina\n6 - Pesquisar Disciplina\n7 - Alterar Disciplina\n8 - Excluir Disciplina\n9 - Sair");
            ...
            switch (opcao) {
                case 1:
                    ...
                    if (idCurso > 0) {
                        ...
                        System.out.println("Informe a ou as disciplinas do curso:");
                        disciplina = scanner.nextLine();                        

                        if (cursoService.insert(idCurso, nome, descricao, disciplina) == true) {
                ...
                case 3:
                    ...
                    if (curso != null) {
                        ...
                        System.out.println("Atualize a disciplinas do curso:");
                        disciplina = scanner.nextLine(); 

                        if (cursoService.update(idCurso, nome, descricao, disciplina) == true) {
                ...
                case 7:
                    ...
                    System.out.println("Informe a disciplina atual do aluno:");
                    materiaAtual = scanner.nextLine();
