...
public class CursoService {
    ...
    public boolean insert(int id, String nome, String descricao, String disciplina) {
    ...
    public boolean update(int id, String nome, String descricao, String disciplina) {
